...
function Product({ id, name, price, image, addToCart, cart, setCart, setCartCount, cartCount}) {
  ...
  return (
    <div className="product-container">
      ...
      <p style={{ color: '#000000' }}><b>{price}</b></p>
...
function Products({addToCart, cart, setCart, setCartCount, cartCount}) {
  const products = [
    ...
    { id: '5', name: 'Custom Gaming PC', price: '$1,299.99', image: 'gamingPC.jpg' },
    { id: '6', name: 'LG 77 inch Smart TV', price: '$1,799.99', image: 'smartTV.jpg' },
    ...
    { id: '9', name: 'Samsung Galaxy Z Fold 4', price: '$1,799.99', image: 'galaxyZFold4.jpg' },
    { id: '10', name: 'Instant Pot Pro Plus 10-Quart Pressure Cooker', price: '$129.99', image: 'InstantPot.jpg' },
    { id: '11', name: 'Apple MacBook Pro 16-inch', price: '$2,399.00', image: 'macbookPro.jpg' },
    { id: '12', name: 'Dell XPS 13', price: '$1,199.99', image: 'dellXPS.jpg' },
  ];
